        ...
        <div class="container px-6 mx-auto">
          ...
          <nav class="flex flex-col md:py-10 py-5 sm:flex-row sm:justify-between sm:items-center">
            ...
            <div class="flex items-center mt-2 sm:mt-0">
              <a href="#" class="px-3 py-1 text-sm font-semibold text-white transition-colors duration-200 transform border-2 rounded hover:bg-gray-700">Downlaod App</a>
            </div>
          </nav>

          <div class="flex flex-col items-center md:py-20 py-10 md:h-128 md:flex-row">
            <div class="md:w-1/2">
              <h2 class="text-3xl font-semibold text-gray-100">Welcome to online radio search website</h2>

              <p class="mt-3 text-gray-100">Discover over 60k online radio stations! New stations are being added daily</p>
            </div>

            <div class="flex mt-8 md:w-1/2 md:justify-center md:mt-0">
              <div class="max-w-sm bg-white rounded-lg dark:bg-gray-800">
                <div class="p-5 text-center">
                  <h2 class="text-1xl font-semibold text-gray-700 dark:text-white fo">Discover radio stations</h2>

                  <form action="#">
                    <div class="mt-4">
                      <input class="block w-full px-4 py-2 mt-4 text-gray-700 placeholder-gray-500 bg-white border border-gray-300 rounded dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" type="text" placeholder="Search radio stations" aria-label="Search" />
                    </div>

                    <div class="flex items-center justify-between mt-4">
                      <button class="px-4 py-2 font-semibold text-white transition-colors duration-200 transform bg-gray-900 rounded hover:bg-gray-800 dark:hover:bg-gray-700 focus:outline-none focus:bg-gray-800 dark:focus:bg-gray-700">Search</button>
                    </div>
                  </form>
                </div>
              </div>
