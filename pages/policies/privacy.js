...
class PrivacyPolicy extends Component {
    ...
    render() {
        const { websiteConfig, lastSearhesResponseHolder} = this.props;

        return (
            <div>
                <Head>
                    <title>Privacy Policy | {websiteConfig.websiteName}</title>
                    <link rel="icon" href="/favicon.ico" />
                </Head>

                <NavBar websiteConfig={websiteConfig} />

                {privacyPolicy(websiteConfig)}
...
function privacyPolicy(websiteConfig) {
    const { websiteName, websiteUrl, contactEmail } = websiteConfig;
    return (
        <section className="bg-gray-50">
            <div className="container mx-auto py-5">
                <div className="block mx-2 md:mx-auto sm:grid bg-white shadow-sm p-5 relative sm:p-2 rounded-lg lg:col-span-2 my-2 md:mb-10">
                    <div className="py-5 self-center sm:pt-0 sm:px-5 text-center md:text-left">
                        <div className="mt-6">
                            <div className="flex justify-between items-center"><span className="font-light text-gray-600">Jun 1,
                                2021</span>
                            </div>
                            <div className="mt-2 document">
                                <h1 className="capitalize">Privacy Policy of {websiteName}</h1>

                                <p>At {websiteName}, accessible from <a href={websiteUrl}>{websiteName}</a>, one of our main priorities is the
                                    privacy of our visitors. This Privacy Policy document contains types of information that is collected and
            recorded by {websiteName} and how we use it.</p>

                                <p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to
            contact us - <strong>{contactEmail}</strong>.</p>
            ...
            company name, address, email address, and telephone number.</p>
                                ...
                                <p>{websiteName} follows a standard procedure of using log files. These files log visitors when they
            ...
            Privacy Policy was created with the help of the <a target="_blank" href="https://www.privacypolicygenerator.info">Privacy
                Policy Generator</a> and the <a target="_blank" href="https://www.privacypolicytemplate.net/">Privacy Policy
                Template</a>.</p>
            ...
            Policy at the following URL – <a target="_blank" href="https://policies.google.com/technologies/ads">https://policies.google.com/technologies/ads</a>
                                </p>
            ...
            access, we hyperlinked to their Privacy Policies below.</p>
                                ...
                                <ul>
                                    <li>
                                        Google <a target="_blank" href="https://policies.google.com/technologies/ads">https://policies.google.com/technologies/ads</a>
                                    </li>
                                </ul>
            ...
            {websiteName}.</p>
                                ...
                                used in their respective advertisements and links that appear on {websiteName}, which are sent
            ...
            advertisers.</p>
                                ...
                                <p>{websiteName}'s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
...
PrivacyPolicy.getInitialProps = async (router) => {
...
export const URL_PATH = '/policies/privacy';
