...
class SearchBar extends Component<WithRouterProps>{
    ...
    render() {
        return (
            <div className="flex flex-col items-center lg:pb-32 lg:pt-15 py-10 md:h-128">
                <form onSubmit={this.onSubmit} className="w-full md:max-w-lg h-10 pl-3 pr-2 bg-white border rounded-full flex justify-between items-center relative">
                    <input
                        type="search"
                        name="search"
    ...
    onSubmit = (event: FormEvent): void => {
        ...
        this.router.push(`/search/by-radio-station/${safeQuery}`);
    }
}
