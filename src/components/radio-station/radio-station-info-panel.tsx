            ...
            <div className="container mx-auto py-5">
                <div className="block mx-2 md:mx-auto sm:grid grid-cols-5 bg-white shadow-sm p-5 relative sm:p-2 rounded-lg lg:col-span-2 my-2 md:mb-10">
                    ...
                    <div className="py-5 self-center sm:pt-0 sm:px-5 col-span-4">
                        <h1 className="text-gray-800 capitalize text-xl font-bold mb-5 text-center md:text-left">{radioStation?.title}</h1>
...
function _streams() {
    return (
        <div className="col-span-5 px-5">
            <h2 className="text-gray-800 capitalize text-xl font-bold mb-5">Available streams</h2>
