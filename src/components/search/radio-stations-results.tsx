    ...
    return (
        <section className="bg-gray-50">
            <div className="container mx-auto">
                <h1 className="text-2xl text-secondary font-bold flex-1 md:py-16 py-5 text-center">Radio stations with name: "{searchResults.query}"</h1>
...
function stationResult(item?: Data) {
    ...
    return (<div key={item.id}>
        <article className="sm:grid grid-cols-5 bg-white shadow-sm p-5 relative sm:p-2 rounded-lg lg:col-span-2 my-2 md:mb-10">
